...
public class SpecUtils {
  ...
  public static ImmutableList<ParameterSpec> buildParameters(
  ...
  @NonNull public static FieldSpec buildField(VariableElement element) {
    return FieldSpec.builder(ClassName.get(element.asType()),
        FIELD_PREFIX + String.valueOf(element.getSimpleName())).build();
  }

  @NonNull public static ParameterSpec buildParameter(VariableElement element) {
    return ParameterSpec.builder(ClassName.get(element.asType()),
        String.valueOf(element.getSimpleName())).build();
  }
}
